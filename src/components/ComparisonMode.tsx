...
export const ComparisonMode = ({ onClose }: ComparisonModeProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-sm animate-fade-in">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 h-full overflow-auto">
        
        {/* Header - Compressed */}
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <div>
            <h2 className="text-2xl sm:text-3xl font-display font-black text-foreground glow-text uppercase">
              Player Comparison
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {players.map((player, idx) => (
            <div
              key={idx}
              className="bg-gradient-card rounded-lg border border-border/50 p-3 sm:p-4 space-y-3 sm:space-y-4 animate-scale-in transition-all duration-500 hover:border-primary/70 hover:shadow-[0_0_40px_hsl(var(--primary)/0.2)]"
            ...
            >
              ...
              {idx === 1 && (
                <Button className="w-full py-2 bg-primary/10 text-primary border border-primary/50 hover:bg-primary/30 font-display font-bold uppercase transition-all duration-300 hover:scale-105 text-sm">
